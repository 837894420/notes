    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonAdd.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(MainActivity.this, com.example.notes.Add.class);
...
//                    Intent intent = new Intent(MainActivity.this, com.example.mengfanshen.note.Research.class);
...
//        });
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){      //配置ArrayList点击按钮
            ...
            public void  onItemClick(AdapterView<?> parent, View view , int position , long id){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.notes.Edit.class);
